"""
Django settings for polyrhythmApp project.
...
ROOT_URLCONF = 'polyrhythmApp.urls'
...
WSGI_APPLICATION = 'polyrhythmApp.wsgi.application'
...
#         'NAME': os.getenv('RDS_DB_NAME','polyrhythm'), #name of the mySQL database
